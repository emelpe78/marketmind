...
## Corpus Check
- 211 files · ~41,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1549 nodes · 2441 edges · 182 communities (145 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af72b8d7`
...
1. `getDb()` - 81 edges
2. `[0.1.1] — 2026-06-09` - 43 edges
3. `[0.1.0] — 2026-06-09` - 37 edges
4. `[0.1.2] — 2026-06-09` - 31 edges
5. `[0.1.3] — 2026-06-09` - 28 edges
6. `createTestDb()` - 23 edges
7. `runAgent()` - 21 edges
8. `setSetting()` - 20 edges
9. `Hinzugefügt` - 18 edges
10. `[0.1.4] — 2026-06-09` - 17 edges
...
Cohesion: 0.05
Nodes (38): getAiConfig(), normalizeAiBaseUrl(), copiedDb, db, dbPath, freshDb, info, result (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (32): isPromoTitle(), normalizeCondition(), parseEbayPrice(), parseListingFromElement(), db, format, prompts, text (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.11
Nodes (12): body, db, domainError, body, db, domainError, AiNotConfiguredError, ListingScrapeError (+4 more)
...
Cohesion: 0.12
Nodes (13): db, event, history, mockChatCompletion, result, db, settings, DEFAULT_AGENTS (+5 more)
...
Cohesion: 0.15
Nodes (48): [0.1.0] — 2026-06-09, [0.1.7] — 2026-06-09, Agent-Manager, Anzeigen-Generator, Behoben, Behoben, Behoben, Behoben (+40 more)
...
Cohesion: 0.12
Nodes (23): id, body, id, calculateProfit(), query, InventoryItem, normalizePlatform(), body (+15 more)
...
Cohesion: 0.13
Nodes (30): copiedDb, db, dbPath, dockerPath, freshDb, info, result, row (+22 more)
...
Cohesion: 0.07
Nodes (34): db, insert, item, mockFetch, profit, summary, updated, db (+26 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (17): db, ebayHtml, fixturesDir, history, kaHtml, listingHtml, mockChatCompletion, normalized (+9 more)

### Community 86 - "Community 86"
Cohesion: 0.19
Nodes (10): id, id, id, AgentInput, AgentWithStats, createAgent(), deleteAgent(), findAgentById() (+2 more)

### Community 88 - "Community 88"
Cohesion: 0.18
Nodes (14): generateAgentPrompt(), getAgentByType(), logAgentHistory(), runAgent(), RunAgentInput, RunAgentMode, RunAgentResult, SKIPPED (+6 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (22): [0.1.3] — 2026-06-09, Behoben, Behoben, Behoben, Behoben, Behoben, Entfernt, Entfernt (+14 more)

### Community 90 - "Community 90"
Cohesion: 0.05
Nodes (37): [0.1.1] — 2026-06-09, Behoben, Behoben, Behoben, Behoben, Behoben, Behoben, Behoben (+29 more)
...
Cohesion: 0.09
Nodes (25): created, db, updated, createSavedResearch(), CreateSavedResearchInput, deleteSavedResearch(), getSavedResearch(), parseJson() (+17 more)
...
Cohesion: 0.24
Nodes (8): AiConnection, mockFetch, authHeaders(), ChatCompletionResult, ChatMessage, FetchFn, fetchModels(), OpenRouterModel
...
Cohesion: 0.29
Nodes (9): db, listAgentsWithStats(), isAiConfigured(), countRows(), getDashboardSummary(), getInventorySummary(), listSavedResearches(), findRecentSearches() (+1 more)
...
Cohesion: 0.17
Nodes (12): [0.1.4] — 2026-06-09, Entfernt, Entfernt, Entfernt, Geändert, Geändert, Geändert, Geändert (+4 more)
...
Cohesion: 0.24
Nodes (8): AgentRow, syncAgentPromptToLibrary(), syncAllAgentPrompts(), agent, db, entry, prompts, types
...
Cohesion: 0.26
Nodes (11): AnalyzeFlipInput, loadSearchResults(), loadStats(), mapSearchResults(), ResearchRunInput, ResearchRunResultRow, ResearchRunSummary, runResearch() (+3 more)

### Community 168 - "Community 168"
Cohesion: 0.12
Nodes (17): db, db, __dirname, getDb(), getDbPath(), resolveSchemaPath(), AGENT_RENAMES, hasColumn() (+9 more)

### Community 169 - "Community 169"
Cohesion: 0.21
Nodes (11): AiConfig, AiProvider, assertAiConfigured(), getAiConfig(), getAiConnection(), normalizeAiBaseUrl(), config, db (+3 more)
...
Cohesion: 0.11
Nodes (21): [0.1.5] — 2026-06-09, [0.1.6] — 2026-06-09, Behoben, Behoben, Behoben, Behoben, Behoben, Changelog (+13 more)

## Knowledge Gaps
- **754 isolated node(s):** `name`, `version`, `description`, `author`, `license` (+749 more)
...
- **Why does `getDb()` connect `Community 168` to `Community 2`, `Community 15`, `Community 21`, `Community 24`, `Community 25`, `Community 163`, `Community 169`, `Community 42`, `Community 61`, `Community 78`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 86`, `Community 88`, `Community 92`, `Community 97`, `Community 100`, `Community 101`, `Community 105`, `Community 106`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `analyzeFlip()` connect `Community 98` to `Community 162`, `Community 105`, `Community 171`, `Community 78`, `Community 84`, `Community 85`, `Community 87`, `Community 88`, `Community 61`?**
